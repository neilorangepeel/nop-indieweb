...
define( 'NOP_INDIEWEB_VERSION', '0.9.12' );
...
require_once NOP_INDIEWEB_DIR . 'includes/webmention/class-privacy.php';
...
if ( defined( 'WP_CLI' ) && WP_CLI ) {
	...
	require_once NOP_INDIEWEB_DIR . 'includes/cli/class-backfill-flight-arcs.php';
	require_once NOP_INDIEWEB_DIR . 'includes/cli/class-backfill-exercise-maps.php';
	...
	\WP_CLI::add_command( 'nop-indieweb backfill-flight-arcs',        \NOP\IndieWeb\Cli\Backfill_Flight_Arcs::class );
	\WP_CLI::add_command( 'nop-indieweb backfill-exercise-maps',      \NOP\IndieWeb\Cli\Backfill_Exercise_Maps::class );
...
function maybe_migrate_profile_urls(): void {
	if ( get_option( 'nop_indieweb_profile_urls_migrated' ) ) {
		return;
	}
	...
	update_option( 'nop_indieweb_profile_urls_migrated', 1, false );
}
