...
if ( ! $post_id ) {
	...
	<div <?php echo wp_kses_data( $wrapper ); ?>>
		<button class="nop-post-footer__pill nop-post-footer__pill--like" type="button" aria-pressed="false" disabled>
			...
			<span class="nop-post-footer__pill-count" aria-label="<?php /* translators: %d: number of likes */ echo esc_attr( sprintf( _n( '%d like', '%d likes', 12, 'nop-indieweb' ), 12 ) ); ?>">12</span>
		</button>
