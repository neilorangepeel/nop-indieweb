		...
		<div id="view-compose">
			...
			<div class="type-grid-wrap">
				...
				<button class="type-btn is-active" data-type="note" aria-pressed="true" type="button">
					...
					<svg class="type-btn__arc" viewBox="0 0 72 72" aria-hidden="true"><path id="arc-note-t" fill="none" d="M14,36 A22,22 0 0 1 58,36"/><path id="arc-note-b" fill="none" d="M58,36 A22,22 0 0 1 14,36"/><text text-anchor="middle"><textPath href="#arc-note-t" startOffset="50%"><?php esc_html_e('Note', 'nop-indieweb' ); ?></textPath></text><text text-anchor="middle"><textPath href="#arc-note-b" startOffset="50%"><?php esc_html_e('Note', 'nop-indieweb' ); ?></textPath></text></svg>
				</button>
				<button class="type-btn" data-type="photo" aria-pressed="false" type="button">
					...
					<svg class="type-btn__arc" viewBox="0 0 72 72" aria-hidden="true"><path id="arc-photo-t" fill="none" d="M14,36 A22,22 0 0 1 58,36"/><path id="arc-photo-b" fill="none" d="M58,36 A22,22 0 0 1 14,36"/><text text-anchor="middle"><textPath href="#arc-photo-t" startOffset="50%"><?php esc_html_e('Photo', 'nop-indieweb' ); ?></textPath></text><text text-anchor="middle"><textPath href="#arc-photo-b" startOffset="50%"><?php esc_html_e('Photo', 'nop-indieweb' ); ?></textPath></text></svg>
				</button>
				<button class="type-btn" data-type="reply" aria-pressed="false" type="button">
					...
					<svg class="type-btn__arc" viewBox="0 0 72 72" aria-hidden="true"><path id="arc-reply-t" fill="none" d="M14,36 A22,22 0 0 1 58,36"/><path id="arc-reply-b" fill="none" d="M58,36 A22,22 0 0 1 14,36"/><text text-anchor="middle"><textPath href="#arc-reply-t" startOffset="50%"><?php esc_html_e('Reply', 'nop-indieweb' ); ?></textPath></text><text text-anchor="middle"><textPath href="#arc-reply-b" startOffset="50%"><?php esc_html_e('Reply', 'nop-indieweb' ); ?></textPath></text></svg>
				</button>
				<button class="type-btn" data-type="like" aria-pressed="false" type="button">
					...
					<svg class="type-btn__arc" viewBox="0 0 72 72" aria-hidden="true"><path id="arc-like-t" fill="none" d="M14,36 A22,22 0 0 1 58,36"/><path id="arc-like-b" fill="none" d="M58,36 A22,22 0 0 1 14,36"/><text text-anchor="middle"><textPath href="#arc-like-t" startOffset="50%"><?php esc_html_e('Like', 'nop-indieweb' ); ?></textPath></text><text text-anchor="middle"><textPath href="#arc-like-b" startOffset="50%"><?php esc_html_e('Like', 'nop-indieweb' ); ?></textPath></text></svg>
				</button>
				<button class="type-btn" data-type="bookmark" aria-pressed="false" type="button">
					...
					<svg class="type-btn__arc" viewBox="0 0 72 72" aria-hidden="true"><path id="arc-bookmark-t" fill="none" d="M14,36 A22,22 0 0 1 58,36"/><path id="arc-bookmark-b" fill="none" d="M58,36 A22,22 0 0 1 14,36"/><text text-anchor="middle"><textPath href="#arc-bookmark-t" startOffset="50%"><?php esc_html_e('Bookmark', 'nop-indieweb' ); ?></textPath></text><text text-anchor="middle"><textPath href="#arc-bookmark-b" startOffset="50%"><?php esc_html_e('Bookmark', 'nop-indieweb' ); ?></textPath></text></svg>
				</button>
				<button class="type-btn" data-type="repost" aria-pressed="false" type="button">
					...
					<svg class="type-btn__arc" viewBox="0 0 72 72" aria-hidden="true"><path id="arc-repost-t" fill="none" d="M14,36 A22,22 0 0 1 58,36"/><path id="arc-repost-b" fill="none" d="M58,36 A22,22 0 0 1 14,36"/><text text-anchor="middle"><textPath href="#arc-repost-t" startOffset="50%"><?php esc_html_e('Repost', 'nop-indieweb' ); ?></textPath></text><text text-anchor="middle"><textPath href="#arc-repost-b" startOffset="50%"><?php esc_html_e('Repost', 'nop-indieweb' ); ?></textPath></text></svg>
				</button>
				<button class="type-btn" data-type="rsvp" aria-pressed="false" type="button">
					...
					<svg class="type-btn__arc" viewBox="0 0 72 72" aria-hidden="true"><path id="arc-rsvp-t" fill="none" d="M14,36 A22,22 0 0 1 58,36"/><path id="arc-rsvp-b" fill="none" d="M58,36 A22,22 0 0 1 14,36"/><text text-anchor="middle"><textPath href="#arc-rsvp-t" startOffset="50%"><?php esc_html_e('RSVP', 'nop-indieweb' ); ?></textPath></text><text text-anchor="middle"><textPath href="#arc-rsvp-b" startOffset="50%"><?php esc_html_e('RSVP', 'nop-indieweb' ); ?></textPath></text></svg>
				</button>
				</div><!-- .type-grid -->
