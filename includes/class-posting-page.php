		...
		<div id="view-compose">
			...
			<div class="type-grid-wrap">
				...
				<button class="type-btn is-active" data-type="note" aria-pressed="true" type="button">
					...
					<svg class="type-btn__arc" viewBox="0 0 72 72" aria-hidden="true"><path id="arc-note" fill="none" d="M12,40 A24,24 0 0 1 60,40"/><text text-anchor="middle"><textPath href="#arc-note" startOffset="50%"><?php esc_html_e('Note', 'nop-indieweb' ); ?></textPath></text></svg>
				</button>
				<button class="type-btn" data-type="photo" aria-pressed="false" type="button">
					...
					<svg class="type-btn__arc" viewBox="0 0 72 72" aria-hidden="true"><path id="arc-photo" fill="none" d="M12,40 A24,24 0 0 1 60,40"/><text text-anchor="middle"><textPath href="#arc-photo" startOffset="50%"><?php esc_html_e('Photo', 'nop-indieweb' ); ?></textPath></text></svg>
				</button>
				<button class="type-btn" data-type="reply" aria-pressed="false" type="button">
					...
					<svg class="type-btn__arc" viewBox="0 0 72 72" aria-hidden="true"><path id="arc-reply" fill="none" d="M12,40 A24,24 0 0 1 60,40"/><text text-anchor="middle"><textPath href="#arc-reply" startOffset="50%"><?php esc_html_e('Reply', 'nop-indieweb' ); ?></textPath></text></svg>
				</button>
				<button class="type-btn" data-type="like" aria-pressed="false" type="button">
					...
					<svg class="type-btn__arc" viewBox="0 0 72 72" aria-hidden="true"><path id="arc-like" fill="none" d="M12,40 A24,24 0 0 1 60,40"/><text text-anchor="middle"><textPath href="#arc-like" startOffset="50%"><?php esc_html_e('Like', 'nop-indieweb' ); ?></textPath></text></svg>
				</button>
				<button class="type-btn" data-type="bookmark" aria-pressed="false" type="button">
					...
					<svg class="type-btn__arc" viewBox="0 0 72 72" aria-hidden="true"><path id="arc-bookmark" fill="none" d="M12,40 A24,24 0 0 1 60,40"/><text text-anchor="middle"><textPath href="#arc-bookmark" startOffset="50%"><?php esc_html_e('Bookmark', 'nop-indieweb' ); ?></textPath></text></svg>
				</button>
				<button class="type-btn" data-type="repost" aria-pressed="false" type="button">
					...
					<svg class="type-btn__arc" viewBox="0 0 72 72" aria-hidden="true"><path id="arc-repost" fill="none" d="M12,40 A24,24 0 0 1 60,40"/><text text-anchor="middle"><textPath href="#arc-repost" startOffset="50%"><?php esc_html_e('Repost', 'nop-indieweb' ); ?></textPath></text></svg>
				</button>
				<button class="type-btn" data-type="rsvp" aria-pressed="false" type="button">
					...
					<svg class="type-btn__arc" viewBox="0 0 72 72" aria-hidden="true"><path id="arc-rsvp" fill="none" d="M12,40 A24,24 0 0 1 60,40"/><text text-anchor="middle"><textPath href="#arc-rsvp" startOffset="50%"><?php esc_html_e('RSVP', 'nop-indieweb' ); ?></textPath></text></svg>
				</button>
				</div><!-- .type-grid -->
